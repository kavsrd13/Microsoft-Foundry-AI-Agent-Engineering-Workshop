"""Foundry setup. https://learn.microsoft.com/azure/foundry/how-to/develop/sdk-overview"""
import os
...
def main() -> None:
    ...
    print("Configured tenant:", os.environ["AZURE_TENANT_ID"])
    print("Configured location (verify in portal):", os.environ["AZURE_LOCATION"])
