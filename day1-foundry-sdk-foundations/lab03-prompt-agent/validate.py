"""Local checks by default; --live checks Azure. https://learn.microsoft.com/azure/foundry/agents/quickstarts/prompt-agent"""
import argparse
import ast
import os
...
def main() -> None:
    ...
    if args.live:
        ...
        assert len(list(project.agents.list_versions(agent_name=state["agent"]))) >= 2
        print("PASS: LIVE two agent versions")
